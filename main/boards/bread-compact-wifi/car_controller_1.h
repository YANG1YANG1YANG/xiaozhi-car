...
public:
    ...
    CarController(
        ...
        // 2. PID 初始化
        pid_init(&pid_left_,  25.0f, 8.0f, 0.0f, 10);
        pid_init(&pid_right_, 25.0f, 8.0f, 0.0f, 10);
        ...
        server.AddTool("car.set_pid",
            "Set PID parameters. All values must be **integers** representing 100 times the actual value. For example, to set Kp=8.0, send 800; for Ki=1.0, send 100. "
