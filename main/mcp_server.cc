...
void McpServer::AddCommonTools() {
    ...
    AddTool("system.set_silent_mode",
        "Enable or disable silent mode. When enabled, the device will not speak TTS responses but still executes commands.",
        PropertyList({
        ...
        [](const PropertyList& properties) -> ReturnValue {
            ...
            ESP_LOGI("MCP", "Silent mode %s", enabled ? "enabled" : "disabled");
            return true;
        });
